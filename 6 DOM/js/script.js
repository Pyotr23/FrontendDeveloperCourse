...
/*REVIEW. Можно лучше. Вставка значений card.link и card.name в интерполяционной строке может привести к угрозе компьютерной безопасности (к уязвимости XSS),
...
Что можно улучшить.
1. Лучше вставлять значения card.link и card.name  не в строке cardNode,
...
2. Лучше обеим формам задать параметр novalidate, чтобы невалидные поля не обводились красной рамкой, потому что встроенная валидация
